...
$(document).ready(function(){$("#my-menu").mmenu({extensions:["theme-black","effect-menu-slide","pagedim-black"],navbar:{title:"Guberniuk Oleksii"},offCanvas:{position:"right"}}),$("#my-menu").data("mmenu").bind("open:start",function(){$(".hamburger").addClass("is-active")}).bind("close:finish",function(){$(".hamburger").removeClass("is-active")}),$(".scills").waypoint(function(){$({blurRadius:5}).animate({blurRadius:0},{duration:1800,easing:"swing",step:function(){$(".scills h3").css({"-webkit-filter":"blur("+this.blurRadius+"px)",filter:"blur("+this.blurRadius+"px)"})}});var i=$.animateNumber.numberStepFactories.separator(" ");$(".scills h3 span").each(function(){var t=$(this).data("count");$(this).animateNumber({number:t,easing:"easeInQuad","font-size":"40px",numberStep:i},1800)})},{offset:"60%"}),$(".btn-contacts").click(function(){$("html, body").animate({scrollTop:$("#my-footer").position().top},2e3)}),$(".btn-about").click(function(){$("html, body").animate({scrollTop:$("#about").position().top},2e3)}),$(".btn-skills").click(function(){$("html, body").animate({scrollTop:$("#skills").position().top},2e3)}),$(".btn-portfolio").click(function(){$("html, body").animate({scrollTop:$("#portfolio").position().top},2e3)}),$(".pulse").click(function(){$("html, body").animate({scrollTop:$("#my-footer").position().top},2e3)}),$(window).on("load",function(){$(".preloader").delay(1e3).fadeOut("slow")});var i=$(".close"),t=$(".pulse");i.click(function(){t.hide(),i.hide()}),(new WOW).init()});