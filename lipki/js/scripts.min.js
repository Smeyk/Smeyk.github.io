...
$(function(){$(".top-line .top-line__second-row .wrap-mnu").click(function(){$(".main-nav").fadeIn()}),$(".main-nav .wrap-nav__left .wrap-mnu").click(function(){$(".main-nav").fadeOut()}),$(".icons-wrap").owlCarousel({loop:!0,smartSpeed:700,dots:!1,nav:!0,autoplay:!0,navText:['<i class="fa fa-long-arrow-left"></i>','<i class="fa fa-long-arrow-right"></i>'],responsiveClass:!0,responsive:{0:{items:1},768:{items:2},992:{items:3},1200:{items:3}}})});